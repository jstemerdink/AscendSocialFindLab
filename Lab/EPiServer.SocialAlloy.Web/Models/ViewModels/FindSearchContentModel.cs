...
namespace EPiServer.SocialAlloy.Web.Models.ViewModels
{
    public class FindSearchContentModel : PageViewModel<FindSearchPage>
    {
        ...
        {
            get { return this.Hits.TotalMatching; }
        }
        ...
        public int TotalPagingPages
        {
            get
            {
                if (this.CurrentPage.PageSize > 0)
                {
                    return 1 + (this.Hits.TotalMatching - 1)/this.CurrentPage.PageSize;
                }
        ...
        {
            get { return this.CurrentPage.ExcerptLength; }
        }
        ...
        { 
        	get { return this.CurrentPage.HitImagesHeight; } 
    	}
        ...
        {
            get { return this.CurrentPage.UseAndForMultipleSearchTerms; }
        }
    }
}
